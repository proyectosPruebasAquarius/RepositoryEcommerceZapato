...
<div class="row justify-content-center">
    <div class="col-12">
      <h2 class="mb-2 page-title">Listado de Marcas</h2>
      <div class="col-12 d-flex justify-content-end mt-3">
          @livewire('backend.marca-component')
        <button type="button" class="btn  btn-primary" data-toggle="modal" data-target="#marcaModal">Agregar <i class="fe fe-plus fe-16"></i></button>
      </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td  class="text-center">
                      ...
                      data-toggle="modal" data-target="#marcaModal" onclick="Livewire.emit('asignMarca',@js($m) )">
