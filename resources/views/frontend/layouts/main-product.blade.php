        ...
        <div class="row">
            ...
            @forelse ($estilos as $estilo)
                <div class="col-sm-4 text-center">
                    <div class="featured">
                        <div class="featured-img featured-img-2" style="background-image: url(@if (strtolower($estilo->nombre) == 'formal') {{ asset('frontend/images/img_bg_2.jpg') }} 
                        @elseif(strtolower($estilo->nombre) == 'deportivo') {{ asset('frontend/images/item-11.jpg') }} @elseif(strtolower($estilo->nombre) == 'casual') {{ asset('frontend/images/women.jpg') }}  
                        @elseif(strtolower($estilo->nombre) == 'playa') {{ asset('frontend/images/playa-women.jpg') }} @else  {{ asset('frontend/images/megamenu.jpg') }} @endif);">
                            <h2>{{ $estilo->nombre }}</h2>
