                    ...
                    <div class="product-desc">
                            ...
                            <div class="block-26 mb-2">
                                ...
                                <ul>
                                    @forelse ($tallas as $tal)
                                        <li  @if ($tal->nombre == $size) class="active" @endif><a type="button" wire:click="$set('size', @js($tal->id_talla))">{{ $tal->nombre }}</a></li>
                                    @empty
                            ...
                            <div class="block-26 mb-4">
                                ...
                                <ul>
                                    @forelse ($colores as $color)
                                        <li style="background: {{ $color->color }}; border: 1px solid #000000" @if ($color->id_color == $style) class="active" @endif><a type="button" wire:click="$set('style', @js($color->id_color))"></a></li>
                                    @empty
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <p class="addtocart"><a type="button" class="btn btn-primary btn-addtocart" onclick="addToCartTrigger()" wire:click="addToCart(@js($product))"><i
                                            class="icon-shopping-cart"></i> Agregar al Carrito</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="tab-pane border fade" id="pills-review" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="review">
                                                    <div class="user-img" style="background-image: url(images/person2.jpg)">
                                                    </div>
                                                    <div class="desc">
                                                        <h4>
                                                            <span class="text-left">Jacob Webb</span>
                                                ...
                                                <div class="review">
                                                    <div class="user-img" style="background-image: url(images/person3.jpg)">
                                                    </div>
                                                    <div class="desc">
                                                        <h4>
                                                            <span class="text-left">Jacob Webb</span>
